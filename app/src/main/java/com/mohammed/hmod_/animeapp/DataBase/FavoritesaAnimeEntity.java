...
public class FavoritesaAnimeEntity implements Parcelable {
    ...
    public FavoritesaAnimeEntity(String id, String posterImage, String canonicalTitle, String synopsis, String createdAt, Integer userCount, Integer favoritesCount) {
        this.id = id;
